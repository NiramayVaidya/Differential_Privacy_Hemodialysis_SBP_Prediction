...
def main():
    ...
    X = tf.compat.v1.placeholder("float", shape=[None, x_size], name='X')
    y = tf.compat.v1.placeholder("float", shape=[None, y_size], name='y')
    ...
    for epoch in range(5):
        ...
        try:
            ...
            saver.save(sess, train_test_helper_funcs_tensorflow.nn_tensorflow_model_save_filename)
            sess.close()
            exit(0)

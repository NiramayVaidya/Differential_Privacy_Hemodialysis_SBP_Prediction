...
impoty train_test_helper_funcs_tensorflow
import time
...
def main():
    ...
    with tf.Session() as sess:
        saver = tf.train.import_meta_graph(train_test_helper_funcs_tensorflow.nn_tensorflow_model_save_filename + '.meta')
        saver.restore(sess, tf.train.latest_checkpoint('saved_models_nn_tensorflow/'))

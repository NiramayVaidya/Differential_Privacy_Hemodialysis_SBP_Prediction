...
def main():
    ...
    for test_pids in test_pids_list:
        ...
        with tf.compat.v1.Session() as sess:
            saver = tf.compat.v1.train.import_meta_graph('nn_tensorflow_' + str(fold) + '.meta')
            ...
            avg_mape += mape
            print('DEBUG - Computed and saved prediction results to prediction_results_tensorflow_2.txt')
